@extends('admin.layout', ['title' => 'Card Activations'])
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <form class="g-3 d-flex justify-content-between">
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto p-1">
                                <a  href="{{route('admin.card.activation.export',request()->all())}}" class="btn btn-primary mb-2">Export</a>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="card-body">
                                            ...
                                            <div class="btn-group">
                                                @if($item->status != 'Blocked')
                                                    ...
                                                    <ul class="dropdown-menu" style="">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.card.activation.update', ['id' => $item->id, 'status' => 'In Process']) }}">In
                                                                Process</a>
                                                        </li>
                                                    </ul>
                                                @else
                    ...
                    <div class="mt-3">
                        {!! $card_activations->appends(request()->all())->links('pagination::bootstrap-5') !!}
                    </div>
