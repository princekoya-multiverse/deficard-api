...
class KycPaymentExport implements FromCollection, WithMapping, WithHeadings, ShouldAutoSize
{
    use Exportable;
    ...
    public function collection()
    {
       ...
       $cards= Payment::where('type', 'kyc')->whereHas('user',function($q) use($request){
            if ($request->search) {
